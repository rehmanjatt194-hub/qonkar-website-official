...
<header class="sticky top-5 z-50 mx-auto sm:px-4">
        ...
        <ul class="flex gap-8 text-white font-medium items-center">
            ...
            <li class="group py-2">
                ...
                <div class="absolute top-full left-0 right-0 mx-auto mt-4 w-[95vw] max-w-[1200px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 p-6 md:p-10 rounded-[15px] shadow-2xl border border-white/10" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 xl:gap-10">
                        ...
                        <div class="flex flex-col gap-3">
                            <h4 class="font-bold text-base xl:text-lg text-[#3F88C8] border-b border-white/10 pb-2 mb-2 whitespace-nowrap">Branding & Performance</h4>
                            <div class="flex gap-4">
                                <div class="w-24 xl:w-32 shrink-0 overflow-hidden rounded-xl border border-white/10 h-24 xl:h-28">
                                    <img src="/images/branding_header.webp" alt="Branding" class="h-full w-full object-cover">
                                </div>
                                <ul class="flex flex-col gap-2 text-[12px] xl:text-[14px] text-gray-300 whitespace-nowrap leading-snug pr-4">
                                    <li><a href="/services/branding-and-digital-marketing" class="hover:text-[#3F88C8] transition">Brand & Digital Marketing</a></li>
                                    <li><a href="/services/seo-services" class="hover:text-[#3F88C8] transition">SEO Services</a></li>
                                    <li><a href="/services/ppc-and-paid-advertising" class="hover:text-[#3F88C8] transition">PPC & Paid Advertising</a></li>
                                    <li><a href="/services/organic-content-strategy" class="hover:text-[#3F88C8] transition">Organic Content Strategy</a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <nav class="glass flex lg:hidden items-center justify-between w-[92%] mx-auto px-5 py-2 rounded-full mt-2 relative">
        <img src="/images/qonkar_logo.webp" alt="Qonkar Logo" class="h-8 w-auto">
        ...
        <div id="mobile-menu" class="hidden absolute top-full left-0 w-full mt-2 z-50 bg-[rgba(10,10,10,0.98)] backdrop-blur-xl flex-col transform scale-y-0 origin-top transition-all duration-300 rounded-2xl overflow-y-auto max-h-[85vh] border border-white/10">
            ...
            <div class="border-b border-white/10">
                ...
                <div id="mobile-services-menu" class="hidden flex-col bg-white/5 pb-4">
                    ...
                    <div class="py-2">
                        <p class="text-[#3F88C8] text-[11px] font-bold uppercase tracking-widest py-2 text-center">Branding</p>
                        <a href="/services/branding-and-digital-marketing" class="block py-2 hover:text-[#3F88C8] text-center text-sm text-gray-300 px-4">Brand & Digital Marketing</a>
                        <a href="/services/seo-services" class="block py-2 text-center text-sm hover:text-[#3F88C8] text-gray-300 px-4">SEO Services</a>
                        <a href="/services/ppc-and-paid-advertising" class="block py-2 hover:text-[#3F88C8] text-center text-sm text-gray-300 px-4">Performance Marketing & PPC paid</a>
                        <a href="/services/organic-content-strategy" class="block py-2 hover:text-[#3F88C8] text-center text-sm text-gray-300 px-4">Organic Content Strategy</a>
