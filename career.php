...
<header class="sticky top-5 z-50 mx-auto sm:px-4">
    ...
    <section class="relative mt-10 lg:mt-16 mb-10 max-w-7xl mx-auto min-h-[65vh] rounded-3xl overflow-hidden flex items-center shadow-[0_20px_50px_rgba(0,0,0,0.4)] border border-white/5">
        
        <!-- Background Image -->
        <!-- Using bg-bottom so the starting point (pin) is not cut off at the bottom -->
        <div class="absolute inset-0 bg-[url('/images/hero-section/career.webp')] bg-cover bg-bottom bg-no-repeat opacity-80"></div>
        
        <!-- Subtle Gradient Overlay to ensure text readability without hiding the image -->
        <div class="absolute inset-0 bg-gradient-to-r from-[#000d16]/90 via-[#000d16]/50 to-transparent"></div>
        <div class="absolute inset-0 bg-gradient-to-t from-[#000d16]/60 via-[#000d16]/20 to-transparent opacity-70"></div>

        <div class="relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left gap-6 py-16 px-6 sm:px-10 lg:px-16 w-full max-w-3xl">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#01a0d8]/20 border border-[#01a0d8]/30 backdrop-blur-md mt-[-40px]">
                <span class="text-[#01a0d8] text-[10px] sm:text-xs font-bold tracking-[0.15em] uppercase drop-shadow-md">Careers At Qonkar</span>
            </div>
            
            <h1 class="text-5xl sm:text-6xl xl:text-7xl font-bold text-white leading-[1.05] drop-shadow-2xl">Join Our Team</h1>
            
            <p class="text-gray-100 text-base lg:text-lg font-light leading-relaxed drop-shadow-lg max-w-xl">
            ...
            <a href="#openings" class="mt-4 inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#01a0d8] text-[#000d16] border border-[#01a0d8] font-bold hover:bg-transparent hover:text-[#01a0d8] transition-all duration-300 shadow-[0_0_20px_rgba(1,160,216,0.3)] hover:shadow-[0_0_30px_rgba(1,160,216,0.5)] group backdrop-blur-sm">
                View Openings 
