<?php
// import_new_case_studies.php
// Upload this file to your live server and run it via browser: https://qonkar.com/import_new_case_studies.php
// It will automatically set up the 4 new case studies in the live database.

require_once __DIR__ . '/db-path.php';
require_once __DIR__ . '/' . ADMIN_URL . '/database_config.php';
...
foreach ($cases as $case) {
    // Check if the study already exists by brand_name or link
    ...
    if ($result->num_rows === 0) {
        ...
        if ($insert->execute()) {
            ...
            // Link category in the bridge table
...
echo "<p style='color:red;'><strong>SECURITY NOTICE:</strong> Please delete this file (<code>import_new_case_studies.php</code>) from your server now that the import is complete.</p>";
?>
