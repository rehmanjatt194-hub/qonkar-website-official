...
<div class="bg-[#000d16] w-full">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                ...
                <div class="lg:col-span-1 flex flex-col h-full">
                    <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group h-full min-h-[300px]">
                        <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                            <div class="text-left">
                            ...
                            <div class="w-full mt-2 overflow-hidden rounded-xl border border-white/5 bg-black/20 p-1">
                                <img src="/images/shopify-responsive-store-design-case-study.webp" alt="Shopify Development mockup" class="w-full h-auto object-cover shadow-md">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 flex flex-col gap-3 md:gap-4">
                    ...
                    <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group flex-1">
                        <div class="w-full h-full flex flex-col sm:flex-row items-center justify-between gap-3 transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                            ...
                            <div class="flex-1 flex justify-center w-full mt-2 sm:mt-0 bg-black/10 rounded-xl p-1.5">
                                <img src="/images/qonkar-custom-software-products-saas-portfolio.webp" alt="Web Development" class="w-full max-w-[220px] h-auto object-contain rounded-xl shadow-md">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        <!-- Speed & Migration -->
                        <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group min-h-[150px]">
                            <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                                <div class="text-left">
                                ...
                                <div class="w-full flex justify-center mt-2 bg-black/10 rounded-lg p-1">
                                    <img src="/images/qonkar-shopify-speed-optimization-services.webp" alt="Speed Optimization" class="w-full max-w-[150px] h-auto object-contain rounded-md shadow-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group min-h-[150px]">
                            <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                                ...
                                <div class="w-full flex justify-center mt-2 bg-black/10 rounded-lg p-1">
                                    <img src="/images/services_pictures/shopify_maintanance.webp" alt="Maintenance" class="w-full max-w-[150px] h-auto object-contain rounded-md shadow-sm">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $bg_image = $mockup;
            $brand = strtolower(trim($row['brand_name']));
            if ($brand == 'careevo') {
                $bg_image = '/images/case-studies/careevo_bg.png';
            }
                    ...
                    <?php foreach ($case_studies_data as $index => $study): ?>
                        <div class="w-full flex-shrink-0 grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch px-1" style="width: 100%;">
                            ...
                            <a href="<?php echo $study['link'] !== '#' ? $study['link'] : '#'; ?>" 
                               ...
                               class="lg:col-span-5 flex items-center justify-center rounded-3xl border border-white/10 bg-[#000d16] p-2 relative overflow-hidden min-h-[240px] sm:min-h-[300px] lg:min-h-0 group transition-all duration-500 hover:border-[#2BB5BC]/40 hover:shadow-none cursor-pointer <?php echo $study['link'] === '#' ? 'pointer-events-none' : ''; ?>">
                                ...
                                <div class="w-full h-full flex items-center justify-center relative z-10 py-2 overflow-hidden rounded-2xl">
                                    <?php if (!empty($study['bg_image'])): ?>
                                        <div class="absolute inset-0 bg-cover bg-center opacity-100 scale-100" style="background-image: url('<?php echo $study['bg_image']; ?>');"></div>
                                        <div class="absolute inset-0 bg-gradient-to-t from-[#000d16]/80 via-[#000d16]/30 to-transparent z-0"></div>
                                    <?php endif; ?>
                                    <div class="w-full h-full flex items-center justify-center transition-transform duration-700 ease-out relative z-10">
                            ...
                            <div class="lg:col-span-7 flex flex-col gap-3">
                                <!-- Top Card: Overview -->
                                <div class="bg-sky-50 border border-slate-200 rounded-3xl p-4 md:p-5 relative hover:border-[#2BB5BC]/40 transition duration-300 group/card">
                                    <?php if ($study['link'] !== '#'): ?>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <?php foreach ($study['tags'] as $tag): ?>
                                            <span class="px-3 py-1 bg-[#2BB5BC]/10 border border-[#2BB5BC]/20 rounded-full text-xs font-semibold text-[#008ba3] hover:bg-[#2BB5BC] hover:text-white transition"><?php echo htmlspecialchars($tag); ?></span>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <div class="bg-sky-50 border border-slate-200 rounded-3xl p-4 hover:border-[#2BB5BC]/40 transition duration-300 flex flex-col justify-between gap-2">
                                        <div class="flex items-center justify-between">
                                            <h4 class="text-xs text-slate-500 uppercase tracking-widest font-semibold">Growth Analytics</h4>
                                            <span class="text-[10px] text-[#047857] px-2 py-0.5 bg-[#ecfdf5] rounded-full font-semibold">Live Sync</span>
                                        </div>
                                    ...
                                    <div class="bg-gradient-to-br from-[#000d16] to-[#021f36] border border-white/10 rounded-3xl p-5 flex flex-col justify-between relative overflow-hidden group/testimonial hover:border-[#2BB5BC]/30 transition-all duration-300">
                                        <!-- Decorative Background Quote Icon -->
                                        <svg class="absolute -top-2 -right-2 w-20 h-20 text-white/[0.03] transform rotate-12 group-hover/testimonial:scale-110 transition-transform duration-500 pointer-events-none" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.041 21.059c-2.422 0-4.385-1.92-4.385-4.281 0-2.361 1.963-4.281 4.385-4.281 0.443 0 0.869 0.063 1.272 0.187-0.013-0.229-0.021-0.459-0.021-0.692 0-3.308 2.684-5.992 5.992-5.992h1.424v4.272h-1.424c-0.949 0-1.72 0.771-1.72 1.72 0 0.179 0.027 0.352 0.076 0.517 0.548-0.165 1.127-0.255 1.725-0.255 3.197 0 5.792 2.595 5.792 5.792s-2.595 5.792-5.792 5.792-5.792-2.595-5.792-5.792c0-0.345 0.032-0.683 0.089-1.012-0.899 0.812-2.091 1.305-3.407 1.305zM23.155 21.059c-2.422 0-4.385-1.92-4.385-4.281 0-2.361 1.963-4.281 4.385-4.281 0.443 0 0.869 0.063 1.272 0.187-0.013-0.229-0.021-0.459-0.021-0.692 0-3.308 2.684-5.992 5.992-5.992h1.424v4.272h-1.424c-0.949 0-1.72 0.771-1.72 1.72 0 0.179 0.027 0.352 0.076 0.517 0.548-0.165 1.127-0.255 1.725-0.255 3.197 0 5.792 2.595 5.792 5.792s-2.595 5.792-5.792 5.792-5.792-2.595-5.792-5.792c0-0.345 0.032-0.683 0.089-1.012-0.899 0.812-2.091 1.305-3.407 1.305z"></path>
                                        </svg>
                                        
                                        <!-- Rating Stars -->
                                        <div class="flex gap-1 text-amber-400 mb-2 relative z-10">
                                        ...
                                        <!-- Client Quote -->
                                        <p class="text-sm md:text-[15px] text-slate-200 font-medium italic leading-relaxed my-3 relative z-10">
                                            “<?php echo htmlspecialchars($study['testimonial']['quote']); ?>”
                                        </p>
                                        
                                        <!-- Client Name -->
                                        <div class="border-t border-white/10 pt-3 mt-auto relative z-10 flex items-center gap-2">
                                            <div class="w-6 h-6 rounded-full bg-[#2BB5BC]/20 flex items-center justify-center text-[#2BB5BC]">
                                            ...
                                            <p class="text-xs font-bold text-[#2BB5BC] uppercase tracking-widest">
                                                <?php 
...
<div class="bg-[#000d16] w-full">
    ...
    <section class="w-full bg-[#000d16] text-white pt-20 pb-0 relative overflow-hidden">
        ...
        <div id="stats-section" class="w-full bg-gradient-to-b from-[#001c30] to-[#000d16] border-t border-white/5 rounded-t-2xl md:rounded-t-[20px] py-5 md:py-6 px-4 md:px-8 shadow-[0_-15px_40px_rgba(0,0,0,0.5)] relative z-10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-12 mb-10 text-left">
                ...
                <div class="w-full md:w-[50%]">
                    <p class="text-[#b5b5b5] font-light text-sm sm:text-base md:text-lg leading-relaxed">
                        We’re not just another agency, we’re your growth partner. Our team combines strategic thinking with data-driven execution to deliver real, measurable impact.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 text-left mt-4 items-stretch">
                ...
                <div class="md:col-span-1 md:row-span-2 lg:col-span-1 lg:row-span-2 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between min-h-[380px] hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div>
                            <span class="w-10 h-10 flex items-center justify-center rounded-xl bg-[#2BB5BC]/10 text-[#2BB5BC] mb-5">
                            ...
                            <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Results-Driven Strategy</h3>
                            <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                We focus on ROI-driven digital marketing and performance metrics. Every campaign is built around your specific business goals, ensuring your marketing budget delivers maximum growth.
                            </p>
                        </div>
                        <div class="mt-6 pt-3 flex items-end justify-center gap-3 w-full bg-slate-100 rounded-2xl p-3.5 border border-slate-200">
                            <div class="flex flex-col items-center gap-1 flex-1">
                                <div class="w-full bg-[#2BB5BC]/30 rounded-t-md h-12"></div>
                                <span class="text-[10px] font-bold text-slate-600">SEO</span>
                            </div>
                            <div class="flex flex-col items-center gap-1 flex-1">
                                <div class="w-full bg-[#95C951]/50 rounded-t-md h-24 relative flex items-center justify-center">
                                    <span class="absolute -top-7 bg-[#95C951] text-white text-[9px] font-bold px-1.5 py-0.5 rounded shadow-sm">+120%</span>
                                </div>
                                <span class="text-[10px] font-bold text-slate-600">ROI</span>
                            </div>
                            <div class="flex flex-col items-center gap-1 flex-1">
                                <div class="w-full bg-[#2BB5BC]/30 rounded-t-md h-16"></div>
                                <span class="text-[10px] font-bold text-slate-600">SaaS</span>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Card 2: Transparent Communication (Wide: Spans 2 cols, 1 row) -->
                <div class="md:col-span-2 md:row-span-1 lg:col-span-2 lg:row-span-1 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col sm:flex-row gap-4 justify-between items-stretch transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div class="flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Transparent Communication</h3>
                                <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                    No hidden metrics or vague updates. You’ll receive clear, honest reporting and open communication at every stage of your project so you always know where things stand.
                                </p>
                            </div>
                        </div>
                        <div class="w-full sm:w-[42%] bg-slate-100 border border-slate-200 rounded-2xl p-3.5 flex flex-col gap-2 justify-center shrink-0">
                            <div class="flex items-center gap-2 text-xs font-bold text-slate-800 bg-white p-2.5 rounded-xl border border-slate-200 shadow-sm">
                                <span class="w-2.5 h-2.5 rounded-full bg-[#95C951]"></span>
                                <span>Weekly Progress Update</span>
                            </div>
                            <div class="flex items-center gap-2 text-xs font-bold text-slate-800 bg-white p-2.5 rounded-xl border border-slate-200 shadow-sm">
                                <span class="w-2.5 h-2.5 rounded-full bg-[#2BB5BC]"></span>
                                <span>Real-time Slack Channel</span>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Card 4: Customized Solutions (Regular: Spans 1 col, 1 row) -->
                <div class="md:col-span-1 md:row-span-1 lg:col-span-1 lg:row-span-1 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div>
                            <span class="w-10 h-10 flex items-center justify-center rounded-xl bg-[#2BB5BC]/10 text-[#2BB5BC] mb-5">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Customized Solutions</h3>
                            <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                We craft custom software, high-performing Shopify designs, and marketing plans tailored to your audience.
                            </p>
                        </div>
                    </div>
                </div>

                <!-- Card 5: Proven Track Record (Regular: Spans 1 col, 1 row) -->
                <div class="md:col-span-1 md:row-span-1 lg:col-span-1 lg:row-span-1 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div>
                            <span class="w-10 h-10 flex items-center justify-center rounded-xl bg-[#2BB5BC]/10 text-[#2BB5BC] mb-5">
                            ...
                            <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Proven Track Record</h3>
                            <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                From fashion and food to SaaS and real estate, we’ve driven success for brands across diverse industries.
                            </p>
                        </div>
                    </div>
                </div>

                <!-- Card 3: Dedicated Account Managers (Regular: Spans 1 col, 1 row) -->
                <div class="md:col-span-1 md:row-span-1 lg:col-span-1 lg:row-span-1 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div>
                            <span class="w-10 h-10 flex items-center justify-center rounded-xl bg-[#2BB5BC]/10 text-[#2BB5BC] mb-5">
                            ...
                            <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Dedicated Managers</h3>
                            <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                Get personal attention with a dedicated expert who understands your brand.
                            </p>
                        </div>
                        <div class="mt-4 pt-3 flex flex-col items-center justify-center bg-slate-100 rounded-2xl p-3 border border-slate-200">
                            <div class="flex -space-x-3">
                                <img src="/images/staff/M-Owais.webp" class="w-9 h-9 rounded-full border-2 border-white object-cover shadow-sm" alt="Team Member">
                                <img src="/images/staff/arsalan.webp" class="w-9 h-9 rounded-full border-2 border-white object-cover shadow-sm" alt="Team Member">
                                <img src="/images/staff/Abdul-Rehman.webp" class="w-9 h-9 rounded-full border-2 border-white object-cover shadow-sm" alt="Team Member">
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Card 6: Agile & Always Evolving (Regular: Spans 1 col, 1 row) -->
                <div class="md:col-span-1 md:row-span-1 lg:col-span-1 lg:row-span-1 bg-white rounded-[24px] border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col justify-between hover:border-[#2BB5BC]/30 hover:shadow-md transition duration-300 group/bento overflow-hidden">
                    <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover/bento:scale-[1.04] origin-center flex-1">
                        <div>
                            <span class="w-10 h-10 flex items-center justify-center rounded-xl bg-[#2BB5BC]/10 text-[#2BB5BC] mb-5">
                            ...
                            <h3 class="text-lg font-bold text-[#000d16] mb-2 group-hover/bento:text-[#0078a8] transition-colors duration-300">Agile & Evolving</h3>
                            <p class="text-slate-700 text-[13px] font-normal leading-relaxed">
                                We adapt quickly to new technology trends and design standards to keep your brand ahead.
                            </p>
                        </div>
                        <div class="mt-4 pt-3.5 flex items-center justify-between gap-2 w-full bg-slate-100 rounded-2xl p-2.5 border border-slate-200">
                            <div class="bg-[#2BB5BC]/20 border border-[#2BB5BC]/40 text-[#008ba3] px-2 py-1.5 rounded-xl text-[9px] font-bold uppercase tracking-wider text-center flex-1">
                                Design
                            </div>
                            <div class="bg-[#95C951]/20 border border-[#95C951]/40 text-[#5f872d] px-2 py-1.5 rounded-xl text-[9px] font-bold uppercase tracking-wider text-center flex-1 animate-pulse">
                                Build
                            </div>
                            <div class="bg-slate-200 text-slate-700 px-2 py-1.5 rounded-xl text-[9px] font-bold uppercase tracking-wider text-center flex-1">
                                Launch
                            </div>
                        </div>
                    </div>
  ...
  <!-- OUR EXPERTS Section -->
    <section class="py-8 md:py-12 mx-auto px-4 sm:px-6 lg:px-8 bg-white text-slate-900 relative fade-in">
        <div class="max-w-7xl mx-auto 0 text-center">
            ...
            <!-- Paragraph -->
            <p class="mt-2 text-slate-600 max-w-2xl mx-auto font-light px-3">
        ...
        <div class="relative mt-10  px-6 sm:px-0">
            <div id="experts-track"
                ...
                <div class="background-backdrop-card card relative flex-shrink-0 w-[70vw] sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5
                            rounded-[15px] border border-[1.087px] border-white/10 
                        bg-[#000d16] p-6 text-center shadow-lg 
                        flex flex-col items-center justify-center space-y-4 h-[320px]
                        group overflow-hidden transition-all duration-500
                        hover:space-y-0 hover:border hover:border-[#12A2A0]">
                    ...
                    <h3 class="text-xl font-semibold text-white relative z-10 group-hover:hidden transition-all duration-500 ease-in-out">
                        Healthcare
                    </h3>
                    ...
                    <p class="text-sm text-slate-300 font-light relative z-10 group-hover:hidden transition-all duration-500 ease-in-out">
            ...
            <button id="experts-btn-prev"
                class="absolute left-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 transition disabled:opacity-30 disabled:cursor-not-allowed"
                disabled>
            ...
            <button id="experts-btn-next"
                class="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 transition disabled:opacity-30 disabled:cursor-not-allowed">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    <path
        ...
        <div class="mt-8 text-center">
            ...
            <a href="/contact-us"
                class="mt-4 w-[300px] py-3 rounded-full bg-[#01a0d8] text-white font-semibold flex items-center justify-center mx-auto gap-2 cursor-pointer hover:bg-[#95C951] hover:text-white transition shadow-md">
                Let’s Get Started
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2  gap-6 mb-12">
              ...
              flex items-center text-left p-4 relative z-10 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-[var(--primary-color)] text-lg mt-1">CEO</p>
                        </div>
                ...
                <div class="relative rounded-xl border border-[var(--secondary-color)]">
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-[var(--primary-color)] text-lg mt-1">COO</p>
                        </div>
        ...
        <div class="w-full mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden transition shadow-[0_2px_8px_rgba(0,13,22,0.02)] hover:border-slate-300 duration-300">
                        <button class="faq-header w-full flex justify-between items-center px-6 py-4 text-left font-semibold bg-white text-slate-800 hover:text-[#01a0d8] transition-colors duration-200">
                            <span>Where is Qonkar Technologies located, and do you work with international clients?</span>
                        ...
                        <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 bg-white">
                            <div class="px-6 pb-5 text-slate-600 font-light text-[14px] leading-relaxed bg-white space-y-2">
                                <p>
                    ...
                    <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden transition shadow-[0_2px_8px_rgba(0,13,22,0.02)] hover:border-slate-300 duration-300">
                        ...
                        <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 bg-white">
                            <div class="px-6 pb-5 text-slate-600 font-light text-[14px] leading-relaxed bg-white">
                                <p>
                                    Typical Shopify projects run 4–6 weeks from kickoff to launch. We move fast by using proven templates, AI-powered recommendations, and real-time feedback loops—so you start selling sooner.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden transition shadow-[0_2px_8px_rgba(0,13,22,0.02)] hover:border-slate-300 duration-300">
                        <button class="faq-header w-full flex justify-between items-center px-6 py-4 text-left font-semibold bg-white text-slate-800 hover:text-[#01a0d8] transition-colors duration-200">
                            <span>Will I own the code and assets after the project is completed?</span>
                            <div class="faq-icon min-w-8 min-h-8 w-8 h-8 flex-shrink-0 flex items-center justify-center rounded-full bg-slate-100 transition-all duration-300">
                                <svg class="w-4 h-4 transition-transform duration-300 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                </svg>
                    ...
                    <div class="faq-item bg-white border border-slate-200 rounded-xl overflow-hidden transition shadow-[0_2px_8px_rgba(0,13,22,0.02)] hover:border-slate-300 duration-300">
                        <button class="faq-header w-full flex justify-between items-center px-6 py-4 text-left font-semibold bg-white text-slate-800 hover:text-[#01a0d8] transition-colors duration-200">
                            <span>Why should I choose Qonkar over other agencies or freelancers?</span>
                            <div class="faq-icon min-w-8 min-h-8 w-8 h-8 flex-shrink-0 flex items-center justify-center rounded-full bg-slate-100 transition-all duration-300">
                                <svg class="w-4 h-4 transition-transform duration-300 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                </svg>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/components/footer.php'; ?>
    ...
    <script src="/script/laser-border.js"></script>
