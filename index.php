                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        ...
                        <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group min-h-[150px]">
                            <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                                ...
                                <div class="w-full flex justify-center mt-2 bg-black/10 rounded-lg p-1">
                                    <img src="/images/qonkar-shopify-speed-optimization-services.webp" alt="Speed Optimization" class="h-11 w-auto object-contain">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#000d16] rounded-[24px] p-4 sm:p-5 border border-white/5 flex flex-col justify-between overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:border-[#2BB5BC]/30 transition-all duration-300 relative group min-h-[150px]">
                            <div class="w-full h-full flex flex-col justify-between transition-transform duration-500 ease-out group-hover:scale-[1.04] origin-center flex-1">
                                ...
                                <div class="w-full flex justify-center mt-2 bg-black/10 rounded-lg p-1">
                                    <img src="/images/services_pictures/shopify_maintanance.webp" alt="Maintenance" class="h-11 w-auto object-contain">
                                </div>
                            </div>
                        </div>
                    </div>
