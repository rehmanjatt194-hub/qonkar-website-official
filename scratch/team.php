...
foreach ($team as $member) {
    ...
    $out .= <<<HTML
                <div class="team-card hidden group relative rounded-2xl overflow-hidden cursor-pointer shadow-lg bg-[#000810]">
                    ...
                    <!-- Gradient Overlay -->
                    <div class="absolute inset-0 bg-gradient-to-t from-[#000d16] via-[#000d16]/50 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-6">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 opacity-0 transform translate-y-8 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0">
                            <a href="$link" target="_blank"
                                class="flex items-center justify-center gap-2 w-full bg-white/5 backdrop-blur-md border border-white/20 text-white px-4 py-2.5 rounded-full font-semibold text-sm hover:bg-[#01a0d8] hover:border-[#01a0d8] hover:text-[#001220] transition-all duration-300">
                    ...
                    <div class="absolute inset-0 border border-white/10 rounded-2xl group-hover:border-[#01a0d8]/60 transition-colors duration-500"></div>
                </div>
