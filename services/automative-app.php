                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex gap-4">
                                ...
                                <ul class="flex flex-col gap-2 text-[12px] xl:text-[14px] text-gray-300 whitespace-nowrap leading-snug pr-4">
                                    ...
                                    <li><a href="/services/automative-app" class="text-[#95C951] transition">Automotive Apps </a></li>
            ...
            <div class="border-b border-white/10">
                ...
                <div id="mobile-services-menu" class="hidden flex-col bg-white/5 pb-4">
                    ...
                    <div class="py-2">
                        ...
                        <a href="/services/automative-app" class="block py-2 text-center text-[#95C951] text-sm text-gray-300 px-4">Automotive App </a>
