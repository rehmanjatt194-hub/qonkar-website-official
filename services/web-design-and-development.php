...
<link rel="canonical" href="<?php echo $finalCanonical; ?>" />
    ...
    <meta property="og:url" content="/services/web-design-and-development" />
    <meta property="og:image" content="/images/web-dev-hero.webp" />
    ...
    <meta name="twitter:image" content="/images/web-dev-hero.webp" />
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
                <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-4"
                    ...
                    &#9679; &nbsp;Qonkar Web Development
                </span>
                <h2 class="text-3xl md:text-5xl font-light mt-3" style="color: #0a1628; line-height:1.15;">
                    Premium <span style="font-weight:800; background: linear-gradient(135deg,#3f89c9,#2fadc3,#85d55c); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">Web Design &amp; Development</span>
                </h2>
                <p class="mt-4 max-w-2xl mx-auto text-base md:text-lg font-light" style="color:#4b5563;">
                    We build bespoke, fast, and secure websites that turn traffic into loyal customers and elevate your brand's digital presence.
                </p>
            </div>
                ...
                <div class="flex flex-col md:flex-row items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-left: 4px solid #3f89c9;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">Bespoke <b>UX/UI Design</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            Say goodbye to boring templates. We create custom-designed, visually stunning mockups tailored to your brand identity. As your <a href="/contact-us" style="color:#3f89c9; font-weight:600; border-bottom:1px solid #3f89c9;">creative design partner</a>, we focus on user engagement.
                        </p>
                        <ul class="space-y-2">
                ...
                <div class="flex flex-col md:flex-row-reverse items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-right: 4px solid #2fadc3;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">Modern <b>Full-Stack Development</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            We build robust, scalable web applications. Our <a href="/contact-us" style="color:#2fadc3; font-weight:600; border-bottom:1px solid #2fadc3;">engineering team</a> uses cutting-edge frameworks to write clean, maintainable, and secure code.
                        </p>
                        <div class="grid grid-cols-2 gap-6 pt-5" style="border-top: 1px solid #f0f9ff;">
                            <div>
                                ...
                                <p class="text-xs font-semibold uppercase tracking-wider" style="color:#6b7280;">Uptime Rating</p>
                            </div>
                            <div>
                                ...
                                <p class="text-xs font-semibold uppercase tracking-wider" style="color:#6b7280;">Responsive Layouts</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-left: 4px solid #85d55c;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">High-Performance <b>Tech Stack</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            We use modern languages and tools to ensure web security, rapid load times, and clean developer Hand-offs for <a href="/contact-us" style="color:#85d55c; font-weight:600; border-bottom:1px solid #85d55c;">future upgrades</a>.
                        </p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-4 py-1.5 rounded-xl text-sm font-semibold" style="background:#f0f9ff; color:#3f89c9; border:1px solid #bae6fd;">React / Next.js</span>
                            ...
                            <span class="px-4 py-1.5 rounded-xl text-sm font-semibold" style="background:#faf5ff; color:#7c3aed; border:1px solid #e9d5ff;">PHP / Laravel</span>
                            <span class="px-4 py-1.5 rounded-xl text-sm font-semibold" style="background:#fff7ed; color:#c2410c; border:1px solid #fed7aa;">Node.js</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row-reverse items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-right: 4px solid #3f89c9;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">Legacy Site <b>to Headless Web</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            We refactor outdated, slow websites into dynamic, lightning-fast modern web experiences that load instantly on all devices.
                        </p>
                        <div class="flex items-center gap-4 p-4 rounded-2xl" style="background:#f0f9ff; border:1px solid #bae6fd;">
                            <span class="font-semibold text-sm" style="color:#374151;">Legacy HTML / PHP</span>
                            ...
                            <span class="px-3 py-1.5 rounded-lg font-bold text-sm text-white" style="background: linear-gradient(135deg,#3f89c9,#2fadc3);">Modern JAMstack</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-left: 4px solid #2fadc3;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">Performance <b>&amp; Search Engine Rank</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            Fast websites rank higher. We optimize loading speeds, configure structured data, and write semantic HTML to boost organic reach.
                        </p>
                        <div class="space-y-4">
                            <div>
                                <div class="flex justify-between text-sm font-semibold mb-2">
                                    <span style="color:#374151;">Lighthouse Performance</span>
                                    <span style="color:#2fadc3; font-weight:700;">99/100</span>
                                </div>
                            ...
                            <div>
                                <div class="flex justify-between text-sm font-semibold mb-2">
                                    <span style="color:#374151;">Mobile SEO Score</span>
                                    <span style="color:#3f89c9; font-weight:700;">98/100</span>
                                </div>
                                <div class="w-full rounded-full h-2" style="background:#e5e7eb;">
                                    <div class="h-2 rounded-full" style="width:98%; background: linear-gradient(90deg,#3f89c9,#85d55c);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col md:flex-row-reverse items-stretch gap-0 rounded-3xl overflow-hidden shadow-lg" style="background:#fff; border:1px solid #e5e7eb;">
                    ...
                    <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center" style="border-right: 4px solid #85d55c;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-2xl font-light" style="color:#0a1628;">Flexible <b>CMS &amp; Admin Panel</b></h3>
                        </div>
                        <p class="text-base leading-relaxed mb-5 font-light" style="color:#4b5563;">
                            Manage your content with ease. We integrate user-friendly content management systems and configure custom dashboards for seamless operations.
                        </p>
                        <ul class="space-y-2">
                            <li class="flex items-center gap-3 text-sm font-medium" style="color:#374151;">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-center">
                <div class="md:w-1/2 space-y-4">
                    <div class="section-pill">OUR TOOLKIT</div>
                    <h2 class="text-3xl md:text-4xl font-light text-white mb-2">
    ...
    <section class="w-full flex justify-center items-center py-12 mx-auto px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-7xl p-8 md:p-16 text-center text-white rounded-[24px] border" style="background-color: #071824; border-color: rgba(26, 58, 74, 0.8);">
            ...
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-light text-white mb-4">
                Ready to <span class="text-[#01a0d8] font-semibold">Build</span> Your Future?
            </h2>
